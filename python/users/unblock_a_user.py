...
# Set the scopes
scopes = ["tweet.read", "users.read", "tweet.write", "offline.access", "block.write"]

# Be sure to replace your-user-id with your own user ID or one of an authenticated user
# You can find a user ID by using the user lookup endpoint
user_id = "your-user-id"

# Be sure to replace id-to-unblock with the id of the user you wish to unblock.
# You can find a user ID by using the user lookup endpoint
...
def main():
    ...
    response = client.users.unblock_user(user_id, target_user_id)
